...
for folder in ['identity','audience','strategy','voice','brand','inspiration']:
 ...
 lines+=['']
lines+=['## Source archive','','Raw material is retained for search and on-demand retrieval; it does not need to be loaded into every context. See the detailed video notes in [[strategy/youtube-library]].','','<details>','<summary>Dated source manifests</summary>','','- [[raw/sources/2026-09-08-brief/manifest|User brief and proposed pillar provenance]]','- [[raw/sources/2026-09-08-linkedin/manifest|Oxygen LinkedIn capture and pagination provenance]]',f'- [[raw/sources/2026-09-08-linkedin-rb2b/manifest|Expanded RB2B LinkedIn archive — {linkedin_count} Adam records]]','- [[raw/sources/2026-09-08-youtube/manifest|YouTube capture and selection boundary]]','- [[raw/sources/2026-09-08-web/manifest|Supplementary public web sources]]','','</details>','','## Retrieval and boundaries','','Use `./scripts/qmd.sh search "terms" -c context` for exact wording, or structured `query`/`vsearch` for conceptual retrieval. Read the full source behind a hit. After updates, run `python3 scripts/build_context_catalog.py`, then `./scripts/qmd-refresh.sh --embed`. The isolated index belongs to this checkout.','','See [[brand/BRAND]] for the separately developed MoltSets company graphics system and its stated scope. This source-research task does not add personal-brand or public-copy approval. Publishing cadence and current offers require a current brief. See [[log]] for the ingest record.']
